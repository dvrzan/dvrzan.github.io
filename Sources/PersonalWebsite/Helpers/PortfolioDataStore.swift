...
struct Conference {
  ...
  static let conferences = [
    Conference(
        past: true,
        name: "NSSpain",
        dateAndCity: "September 2024 - Logroño, Spain",
        talkTitle: "🎦 Best-in-class Pull Request",
        talkURL: "https://vimeo.com/showcase/11503067/video/1011641324"
    ),
    Conference(
        past: true,
        name: "iOSDevUK",
        dateAndCity: "September 2024 - Aberystwyth, UK",
        talkTitle: "Best-in-class Pull Request",
        talkURL: ""
    ),
    Conference(
