...
//  
//
//  Created by Danijela Vrzan on 2022-01-22.
//
...
enum Constants {
  ...
  enum Portfolio {
    static let introTitle = "Speaking"
  ...
  enum About {
    ...
    static let introAboutFirst = "I'm an iOS Developer at "
  ...
  enum URL {
    ...
    static let conferenceTalk = "/images/utils/conference-talk.jpeg"
